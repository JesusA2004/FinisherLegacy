...
<template>
    ...
    >
        <span
            v-if="eyebrow"
            class="inline-flex items-center gap-2 text-xs font-semibold tracking-[0.3em] text-fl-gold-soft uppercase"
        >
            <span class="h-px w-6 bg-fl-gold-soft/60" aria-hidden="true" />
            {{ eyebrow }}
        </span>
        <h2
