...
const cards = [
    ...
    { label: 'Prerregistros', value: stats.preregistrations, icon: ClipboardList },
    { label: 'Placas hoy', value: stats.plates_today, icon: Boxes },
    { label: 'Pendientes de producción', value: stats.pending_production, icon: Boxes },
    { label: 'Entregadas', value: stats.delivered, icon: PackageCheck },
    { label: 'Incidencias abiertas', value: stats.open_incidents, icon: TriangleAlert },
];
</script>
...
<template>
    ...
    <div class="p-4 md:p-8">
        ...
        <div class="mt-8 rounded-xl border border-white/10 bg-fl-graphite/40 p-5">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                >
                    ...
                    <span class="ml-2 font-semibold text-white">{{ count }}</span>
                </div>
            </div>
        </div>
    </div>
