...
<template>
    ...
    <div class="p-4 md:p-8">
        ...
        <div class="mb-6 grid grid-cols-2 gap-3 rounded-xl border border-white/10 bg-fl-graphite/30 p-4 text-sm md:grid-cols-4">
            <div>
            ...
            <div>
                <p class="text-xs text-white/30 uppercase">Fecha de nacimiento</p>
        ...
        <section class="mb-6">
            <h2 class="mb-2 flex items-center gap-1.5 text-sm font-semibold text-white/70">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-4 py-3">{{ p.official_time ?? '—' }}</td>
                            <td class="px-4 py-3 text-white/40">{{ p.source }}</td>
                        </tr>
                        <tr v-if="!participations.length">
                            <td colspan="6" class="px-4 py-10 text-center text-white/30">
        ...
        <div class="grid gap-6 md:grid-cols-2">
                ...
                <div class="space-y-2">
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <span class="font-mono text-white/70">{{ plate.serial_number }}</span>
                            <Badge variant="outline" class="border-white/20 text-white/50">{{ plate.status }}</Badge>
                        </div>
                    ...
                    <p v-if="!plates.length" class="text-sm text-white/30">Sin placas.</p>
                </div>
            </section>
            ...
            <section>
                ...
                <div class="space-y-2">
                    ...
                    <p v-if="!medals.length" class="text-sm text-white/30">Sin medallas.</p>
                </div>
            </section>
        </div>
    </div>
